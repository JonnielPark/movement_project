...
| 항목 | 가이드 |
|---|---|
| 거리 | 스마트폰 화면에 기준 매트 전체가 들어오도록 약 3걸음, 즉 200-250 cm 뒤로 이동한다. |
| 대각선 촬영 | `Z1` 또는 `Z3`에서는 기준 매트 앞쪽 모서리를 기준으로 카메라 방향을 맞춘다. |
| 측면 촬영 | `Z4` 또는 `Z6`에서는 기준 매트의 긴 변이 화면 중심축과 평행하도록 맞춘다. |
