...
**Korean Sync:** `docs/_terminology.md` is the same-version Korean source.  
**Numbering Policy:** The final document-number prefix will be added to the filename after development is complete.
