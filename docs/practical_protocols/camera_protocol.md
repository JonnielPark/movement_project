...
|---|---|---|---|
| 스쿼트 | Z1 / Z8 | H2 | 정면 무릎 추적을 중심으로 관찰하되, 전방 좌측 대각에서 고관절 깊이 맥락을 보완 |
| 런지 | Z2 / Z7 | H2 | 무릎 전방 이동과 체간/하지 시상면 정렬 관찰 |
| 파이크 푸쉬업 | Z2 / Z7 | H1 | 어깨 각도와 힙 힌지 구조 변화 관찰 |
| 플랭크 숄더탭 | Z1 / Z8 | H1 | 체중 이동 중 골반 회전과 측방 흔들림 관찰 |
