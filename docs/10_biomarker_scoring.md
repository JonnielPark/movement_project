...
**영문 동기화:** `docs_eng/10_biomarker_scoring.md`는 동일 버전의 영문 번역본이다.
...
src/movement/biomarker/interpretation.py  load_rules, derive_interpretations,
                                          ...
                                          예외 발생하지 않음
data/interpretation_rules/squat.yaml   6개 규칙 (floor_hit, dominant_domain,
data/interpretation_rules/lunge.yaml      load_shift, score 임계값)
