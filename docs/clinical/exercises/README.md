...
먼저 갱신한 뒤에만 `compensation_candidates`, `analysis_disrupting_patterns`, feature registry,
...
| Label | 의미 |
|---|---|
| Scoring candidate | 관절 포인트 시계열에서 식별 가능해 향후 feature/biomarker로 연결할 수 있는 패턴 |
...
| Medium detectability | 적절한 view, visibility, annotation support가 필요함 |
...
불안정할 수도 있다. 먼쪽 visibility나 jitter가 나쁘면 해당 feature를 나쁜 movement quality가
