...
기준 매트의 정면 중심선(`Z1`) 또는 전방 좌측 대각 위치(`Z8`)에 카메라를 둔다.
렌즈 높이는 골반 또는 배꼽 높이인 약 80-110 cm로 맞춘다.
...
기준 매트 기준 전방 우측 대각 위치(`Z2`) 또는 좌측 시상면 위치(`Z7`)에 카메라를 둔다.
렌즈 높이는 골반 높이인 약 80-110 cm로 맞춘다.
