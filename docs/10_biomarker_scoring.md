...
- Trend-over-set `BiomarkerTrendRecord` (aggregate slope across reps within
  a set, fatigue signature)
- Backwards-compatibility migration when YAML version changes mid-baseline
